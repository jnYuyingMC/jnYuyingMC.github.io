// i18n dictionary — photo.html page-specific keys
export const pageDict = {
  zh: {
    title: '图片库 - 大育英帝国 Minecraft 计划',
    'page.title': '图片库',
    'page.backHome': '返回首页',
