...
export const sharedDict = {
  zh: {
    ...
    'footer.disclaimer': '本作品非官方 Minecraft 产品。未经 Mojang 或 Microsoft 批准或关联。',
  ...
  en: {
    ...
    'email.reveal': 'Click to reveal',
    'captcha.title': 'Verification',
    'captcha.loading': 'Loading...',
    'captcha.cancel': 'Cancel',
    'captcha.error': 'Failed to load. Please refresh.',
