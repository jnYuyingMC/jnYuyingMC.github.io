...
export const pageDict = {
  zh: {
    ...
    'changelog.v20260608.title': '地区选择与 CDN 切换 (deprecated)',
    ...
    'changelog.v20260402b.body': '<ul><li>视频板块新增本地施工纪录视频（photolib/2017-7-13-video.mp4），通过原生 &lt;video&gt; 播放，禁用下载</li><li>视频板块支持 B 站 iframe 与本地视频切换（分段按钮）</li><li>旧版 VR 页面（vrview/examples/yuying/index.html）引入主站配色与整体设计重构 (deprecated)</li><li>旧版 VR 页添加 Logo、使用说明卡片及 Google VR View 官方文档链接 (deprecated)</li><li>旧版 VR 页添加暗色模式切换按钮，localStorage 持久化 (deprecated)</li><li>旧版 VR 页添加与主站一致的 FAB 导航（Home / VR） (deprecated)</li><li>旧版 VR 页 Footer 与主站统一（组织名、版权、GitHub Logo、技术栈） (deprecated)</li><li>导航按钮改为 tonal 风格 + Material Icons (deprecated)</li><li>所有外链添加 open_in_new 图标 (deprecated)</li><li>保留 Google VR View 框架文件（style.css / vrview.js / index.js）不动 (deprecated)</li></ul>',

    'changelog.v20260402a.title': '团队架构 & UI 迭代',
    'changelog.v20260402a.body': '<ul><li>新增团队架构板块（核心组 / 建筑组 / 美术组 / 渲染组），结构化卡片布局</li><li>团队板块添加群二维码，点击弹出 QQ 群链接对话框</li><li>Footer GitHub 链接旁添加 GitHub 图标</li><li>Hero 区链接替换为 B 站正片与重制版</li><li>VR 页恢复自建源与 GitHub VR 选项，附弃用提示弹窗 (deprecated)</li><li>GitHub VR 卡片引用 Google VR View 官方说明</li><li>统一所有 VR 卡片按钮为 variant="tonal" 风格</li><li>三个页面所有外链添加 open_in_new 图标</li><li>Timeline 新增 2017.11.5 正片发布条目</li><li>创建 CHANGELOG.md 供未来 AI Agent 参考</li><li>更新 README.md 补充 VR 移除与旧版清理说明</li></ul>',
  ...
  en: {
    ...
    'changelog.v20260608.title': 'Region Selection & CDN Switching (deprecated)',
    ...
    'changelog.v20260402b.body': '<ul><li>Added local construction-record video (photolib/2017-7-13-video.mp4) via native &lt;video&gt; with nodownload</li><li>Video section supports Bilibili iframe + local video switching via segmented buttons</li><li>Redesigned legacy VR page (vrview/examples/yuying/index.html) with full main-site theming (deprecated)</li><li>Added project logo, info card with usage instructions and Google VR View docs link to legacy VR page (deprecated)</li><li>Added theme toggle (light/dark) to legacy VR page, persisted via localStorage (deprecated)</li><li>Added FAB navigation (Home / VR) matching main site to legacy VR page (deprecated)</li><li>Added footer consistent with main site (org name, copyright, GitHub logo, tech stack) (deprecated)</li><li>Navigation buttons upgraded to variant="tonal" with Material Icons (deprecated)</li><li>All external links marked with open_in_new icon (deprecated)</li><li>Preserved Google VR View dependencies (style.css / vrview.js / index.js) untouched (deprecated)</li></ul>',

    'changelog.v20260402a.title': 'Team Structure & UI Refinements',
    'changelog.v20260402a.body': '<ul><li>Added team structure section (Core / Building / Art / Rendering) with structured card layout</li><li>Added group QR code in team section with dialog popup</li><li>Added GitHub logo icon next to footer GitHub link</li><li>Hero section: replaced VR links with Bilibili video links (main video + remaster)</li><li>VR page: restored self-hosted source and GitHub VR options with deprecation dialogs (deprecated)</li><li>Added Google VR View official reference and link in GitHub VR card</li><li>Unified all VR card buttons to variant="tonal" style</li><li>Added open_in_new icon to all external links across three pages</li><li>Added timeline entry: 2017.11.5 main video release</li><li>Created CHANGELOG.md for future AI agent reference</li><li>Updated README.md with VR removal and legacy cleanup notes</li></ul>',
